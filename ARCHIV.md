...
| `everyNRooms` (`data/upgrades.json`) | 9 | War bereits vor Phase 9 totes Datenfeld — die Raumtyp-Regel steuerte das Kartenangebot schon strukturell (nur combat/elite/cursed bauen einen Kampfzustand) | `archive/systeme-v1.md` (Abschnitt 6) | Reine Datenfeld-Wiederherstellung; ein echter "alle N Räume"-Mechanismus existierte so nie und müsste neu gebaut werden. |
