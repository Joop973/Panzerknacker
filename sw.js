...
const CACHE = 'panzerknacker-v130';
const PREV_CACHE = 'panzerknacker-v129'; // bleibt fuer eine evtl. offene Alt-Seite intakt
...
const ASSETS = [
  ...
  'src/game/state.js',
  'src/game/state_init.js',
  'src/game/state_world.js',
  'src/game/state_damage.js',
  'src/game/state_fx.js',
  'src/game/enemymechanics.js',
  'src/game/status.js',
